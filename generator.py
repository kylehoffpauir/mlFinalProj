...
# https://www.emnlp2015.org/proceedings/EMNLP/pdf/EMNLP221.pdf
# https://arxiv.org/pdf/1612.03205.pdf
# https://github.com/robbiebarrat/rapping-neural-network/blob/master/model.py
...
train_mode = False
artist = "Montana of 300" # used when saving the trained model
...
def main(depth, train_mode):
    ...
    text_file = "hiphop/Montana of 300_lyrics.txt"
